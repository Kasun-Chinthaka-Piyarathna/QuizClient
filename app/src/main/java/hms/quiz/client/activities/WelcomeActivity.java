...
public class WelcomeActivity extends AppCompatActivity implements OnRegSmsReceivedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HttpAsyncTask.setOnRegSmsReceivedListener(this);
        // Get the activity
...
//
                            new HttpAsyncTask().execute(Constant.baseUrl+Constant.urlParamStop);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
...
//                                    Toast.LENGTH_LONG).show();
                            new HttpAsyncTask().execute(Constant.baseUrl+Constant.urlParamRegister);
        ...
        if (listenerRegisteredStatus.equals(getString(R.string.welcome_activity_register_response))) {
            ...
            builder.setPositiveButton(ssBuilder, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    finish();
                    new HttpAsyncTask().execute(Constant.baseUrl+Constant.urlParamPlay);
...
//                            smsManager.sendTextMessage(String.valueOf(Constant.destinationAddress), null, Constant.stopCommand, null, null);
//
                       //     new HttpAsyncTask().execute("http://quizclient.000webhostapp.com/welcome.php?action=STOP");
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
